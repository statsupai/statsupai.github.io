...
1. In `.github/workflows/auto-assign-maintainer.yml`, set the maintainer’s GitHub username in the `assignee` configuration so new PRs are assigned to the correct maintainer.
